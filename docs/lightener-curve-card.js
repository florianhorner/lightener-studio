...
</svg>`;const Lt=["light"];class Dt extends de{constructor(){super(...arguments),this._config={},this._hass=null,this._picker=new xe(()=>this.isConnected,()=>this.requestUpdate())}connectedCallback(){super.connectedCallback(),this._picker.ensureLoaded()}setConfig(e){this._config=e,this._picker.ensureLoaded()}set hass(e){this._hass=e,this._picker.ensureLoaded()}_fireConfigChanged(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_commitConfigKey(e,t){const i=Object.fromEntries(Object.entries(this._config).filter(([t])=>t!==e));this._config=t?{...i,[e]:t}:i,this._fireConfigChanged()}_onEntityChange(e){this._commitConfigKey("entity",e.detail?.value??"")}_onTitleChange(e){this._commitConfigKey("title",e.target.value)}_onFallbackEntityInput(e){this._commitConfigKey("entity",e.target.value.trim())}render(){const e=this._config.entity??"",t=this._config.title??"",i=this._hass?function(e){const t=e.entities;return t?Object.keys(t).filter(t=>ye(e,t)):[]}(this._hass):[];return j`
      <div class="form">
        <div class="field">
          <label>Entity</label>
