  ...
  >
    ...
    `,n=this.curves.filter(t=>t.visible).map(i=>{const r=Tt(Ot(i.controlPoints,t));return K`
      ...
      />`}case"bar":{const t=2*r,a=.75*r;return K`<rect
        ...
        style="${d}"
        pointer-events="none"
      />`}default:return t}}(Ht[e%Ht.length],Lt(i.lightener),Tt(i.target),6,`control-point ${s?"origin":""} ${a?"dragging":""} ${l?"hovered":""} ${this._focusedPoint?.curve===e&&this._focusedPoint?.point===o?"focused":""}`,n,t.color,d,t.color)}
          `})}
